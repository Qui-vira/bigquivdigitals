 ...
 * sells Ophir's Codex himself, through BigQuiv Digitals — the foundation does
...
const TO =
  ...
  "The foundation is a non-profit. Ophir's Codex, my paid course, is a separate BigQuiv Digitals product.";
